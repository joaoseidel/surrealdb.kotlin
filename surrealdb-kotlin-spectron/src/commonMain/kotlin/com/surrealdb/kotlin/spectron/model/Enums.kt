...
public enum class QueryKind(
    ...
    @SerialName("direct_lookup")
    DIRECT_LOOKUP("direct_lookup"),

    @SerialName("hybrid")
    HYBRID("hybrid"),

    @SerialName("full_context")
...
@Serializable
public enum class GraphEdgeKind(
    public val wire: String,
) {
    @SerialName("knowledge_has_keyword")
    KNOWLEDGE_HAS_KEYWORD("knowledge_has_keyword"),

    @SerialName("section_match")
    SECTION_MATCH("section_match"),

    @SerialName("document_link")
    DOCUMENT_LINK("document_link"),

    @SerialName("document_summary")
    DOCUMENT_SUMMARY("document_summary"),

    @SerialName("keyword_cooccurrence")
...
public enum class DocumentStatus(
    ...
    @SerialName("keywording")
    KEYWORDING("keywording"),

    @SerialName("extracting_nodes")
...
@Serializable
public enum class BatchExtractionMode(
    public val wire: String,
) {
    @SerialName("per_message")
    PER_MESSAGE("per_message"),

    @SerialName("whole_conversation")
