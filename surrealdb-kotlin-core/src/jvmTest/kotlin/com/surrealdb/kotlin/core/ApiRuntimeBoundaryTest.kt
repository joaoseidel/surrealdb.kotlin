 ...
 *
 * `ConnectionController` is the one entry. It never reaches the public API: `Session`
...
class ApiRuntimeBoundaryTest {
    private val allowed =
        setOf(
            "Surreal.kt -> com.surrealdb.kotlin.core.runtime.ConnectionController",
            "Session.kt -> com.surrealdb.kotlin.core.runtime.ConnectionController",
        )

    private val apiRoot = File("src/commonMain/kotlin/com/surrealdb/kotlin/core/api")
    ...
    private companion object {
        val IMPORT = Regex("""^import (com\.surrealdb\.kotlin\.core\.runtime[A-Za-z0-9_.]*)""")
    }
}
