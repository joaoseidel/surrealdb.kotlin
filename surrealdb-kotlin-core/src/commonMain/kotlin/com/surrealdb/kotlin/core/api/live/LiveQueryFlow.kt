...
import com.surrealdb.kotlin.core.api.error.SurrealLiveQueryException
...
internal fun <T> liveEventFlow(
    ...
    flow {
        ...
        // Confined to this collection, it records what this collector started.
        // That is exactly what onCompletion may need to kill, and nothing else.
