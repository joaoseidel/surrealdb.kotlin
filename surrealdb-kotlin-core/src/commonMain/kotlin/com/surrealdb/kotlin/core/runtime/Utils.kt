...
internal fun isWsUrl(url: String): Boolean = url.startsWith("ws://") || url.startsWith("wss://")
...
internal fun httpToWsUrl(url: String): String =
    when {
...
internal fun wsToHttpUrl(url: String): String =
    when {
